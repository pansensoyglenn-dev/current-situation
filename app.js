...
// visitors and share links point to (Cloudflare Pages/Workers, connected to
// the GitHub repo). CANONICAL_URL: the SEO-declared "authoritative" address —
// used only in <link rel="canonical"> and og:url tags. Kept separate since
// this repo is mirrored to more than one host.
const SITE_URL = 'https://rhythmic.pansensoyglenn150.workers.dev/';
