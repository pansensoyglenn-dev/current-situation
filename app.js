...
function articleStaticHtml(article, cat, pageUrl, imageAbsUrl) {
...
<head>
  ...
  <meta property="og:url" content="${pageUrl}">${imageTag}
...
async function deployArticleToGitHub(article) {
  ...
  try {
    ...
    const pageHtml = articleStaticHtml(article, cat, pageUrl, imageAbsUrl);
